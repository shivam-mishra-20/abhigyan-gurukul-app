...
import { Bell, Calendar, CheckCircle, Plus, Upload } from "lucide-react-native";
...
export default function TeacherHome() {
  ...
  const [liveSchedule, setLiveSchedule] = useState<LiveScheduleResponse | null>(
    null,
  );
  ...
  const activeBatchesCount = liveSchedule?.todaySchedule
    ? new Set(liveSchedule.todaySchedule.map((s) => s.batch).filter(Boolean))
        .size
    : 0;
      ...
      >
        ...
        <View style={styles.section}>
          ...
          {scheduleLoading ? (
            ...
            liveSchedule.todaySchedule.length > 0 ? (
            <ScrollView
              horizontal
                ...
                .map((item, index) => {
                  ...
                  return (
                    <Pressable
                      ...
                      style={[
                        styles.classCard,
                        isOngoing && styles.classCardActive,
                      ]}
                    ...
                    >
                      <View style={styles.classCardHeader}>
                        ...
                        <Text
                          style={[
                            styles.classTime,
                            isOngoing && styles.classTimeActive,
                          ]}
                        >
                          {item.startTimeSlot}
                        </Text>
                      ...
                      <Text
                        style={[
                          styles.subjectName,
                          isOngoing && styles.subjectNameActive,
                        ]}
                        numberOfLines={1}
                      >
                        {item.subject}
                      ...
                      <Text
                        style={[
                          styles.batchName,
                          isOngoing && styles.batchNameActive,
                        ]}
                      >
                      ...
                      <View style={styles.cardFooter}>
                        <Text
                          style={[
                            styles.actionLink,
                            isOngoing && styles.actionLinkActive,
                          ]}
                        >
